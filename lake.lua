...
local gears = ask("gears")
local awful = ask("awful")
awful.rules = ask("awful.rules")
awful.autofocus = ask("awful.autofocus")
...
local menubar = ask("menubar")
local vicious = ask("vicious")
...
set_var("default_layout", awful.layout.suit.floating)
...
for s = 1, screen.count() do
    ...
    -- Add lake widgets
	print("Adding lake left widgets (" .. #lake_to_left .. ")...")
	...
	print(" ok")
    print("Adding lake right widgets (" .. #lake_to_right .. ")...")
...
print("Adding lake global hotkeys (" .. #lake_global_keys .. ")...")
for i, v in pairs(lake_global_keys) do
	globalkeys = awful.util.table.join(globalkeys, v)
end
print(" ok")
...
print("Adding lake client hotkeys (" .. #lake_client_keys .. ")...")
for i, v in pairs(lake_client_keys) do
	clientkeys = awful.util.table.join(clientkeys, v)
end
print(" ok")
